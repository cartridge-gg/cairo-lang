...
PROGRAM_PATH = get_build_dir_path(
    "src/starkware/cairo/cairo_verifier/cairo_verifier_compiled_recursive.json"
)
HASH_PATH = get_source_dir_path(
    rel_path="src/starkware/cairo/cairo_verifier/layouts/recursive/program_hash.json",
